...
<body>
    ...
    <section class="search-form">
        <form action="" method="POST" id="searchForm">
            <input type="text" id="search" name="search_box" class="box" placeholder="Search products...">
            <input type="submit" name="search_btn" class="btn" value="Search">
        </form>
    </section>
    ...
    <script>
        $(document).ready(function() {
            // Function to send AJAX request when there is a change in the search input
